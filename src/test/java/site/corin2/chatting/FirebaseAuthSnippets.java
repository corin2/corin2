...
public class FirebaseAuthSnippets {
  ...
  public static void createUser() throws InterruptedException, ExecutionException {
    ...
    CreateRequest request = new CreateRequest()
        ...
        .setDisplayName("Halls")
        .setPhotoUrl("https://thumbs.dreamstime.com/b/profile-icon-male-avatar-portrait-casual-person-silhouette-face-flat-design-vector-46846328.jpg")
        .setDisabled(false);
  ...
  public static void main(String[] args) throws InterruptedException, ExecutionException {
    ...
    // Smoke test
    createUserWithUid();
    System.out.println("사용자 정보 가져온다");
