...
public interface TroubleDAO {
	...
	//트러블 슈팅 팀 검색 게시물 수
	public int troubleSearchActCount(@Param("projectNum")int projectNum,@Param("search")String search,@Param("type") String type);
	
	//트러블 슈팅게시물 전체 검색어 게시물 수
	public int troubleSearchCount(String searchWord);
		
	//트러블 슈팅게시물 태그로 검색 게시물 수
	public int troubleSearchTagCount(String searchTag);
