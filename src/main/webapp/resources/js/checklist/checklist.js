...
function updateCheckListAdd(index,checkNum) {
	...
	var div = "<td id='checkBoxAdd' colspan='3'><input id='CheckBoxInput' type='text' class='inputtext checkFloat' onkeyup='fnChkByte(this, 100)' onkeypress='if(event.keyCode==13) {updateCheckListContent("+checkNum+");}'>"
			+ "</td><td>"		
